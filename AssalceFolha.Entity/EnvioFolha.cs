...
{
    [TableName("TB_ENVIO_FOLHA")]
    public class EnvioFolha: EntityBase<EnvioFolha>
    {
        [TableField(true, IsIdentity = true, IsKey = true, NameField = "CD_ENVIO_FOLHA")]
        ...
        [TableField(true, AllowZero =true, IsRequired = true, FillCritical = "Informe o evento !", NameField = "CD_EVENTO")]
        public int Evento { get; set; }

        [TableField(true, AllowZero = true, IsRequired = true, FillCritical = "Informe o valor !", NameField = "VALOR")]
        public double Valor { get; set; }
        
        [TableField(true, NameField = "ST_FORA_FOLHA")]
        public bool ForaFolha{ get; set; }
