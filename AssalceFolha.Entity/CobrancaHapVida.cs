...
{
    [TableName("TB_COBRANCA_HAPVIDA")]
    public class CobrancaHapVida : EntityBase<CobrancaHapVida>
    {
        [TableField(true, IsIdentity = true, IsKey = true, NameField = "CD_COBRANCA_HAPVIDA")]
        ...
        public int MatriculaHapVida { get; set; }
